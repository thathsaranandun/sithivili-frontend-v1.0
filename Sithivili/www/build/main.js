...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, alertCtrl, dataService) {
        ...
        this.logoImg = this.dataService.logoImgURL;
...
var DataService = /** @class */ (function () {
    function DataService(http, domSanitizer) {
        ...
        this.bearer = 'Bearer sithivilisbbebt';
        ...
        this.logoImgURL = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUjnDgJ4RLpEfSQxbdrN2ua-hTdDgOQXDMgUNq_6FPWJG6w3DNgw&s";
    }
    //SPRING BOOT SERVER REQUESTS
    DataService.prototype.deleteUser = function (id) {
        return this.http.delete(this.baseurl + 'api/users/user/delete/' + id, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpHeaders */]().set('Authorization', this.bearer) });
    };
    DataService.prototype.addVolunteer = function (name, password, gender) {
        return this.http.post(this.baseurl + 'api/admin/new/volunteer', {
            ...
            'password': password,
            'gender': gender
        }, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpHeaders */]().set('Authorization', this.bearer) });
    };
    ...
    DataService.prototype.loadVolunteers = function () {
        return this.http.get(this.baseurl + 'api/users/volunteers/all', { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpHeaders */]().set('Authorization', this.bearer) });
    };
    DataService.prototype.getUserById = function (id) {
        return this.http.get(this.baseurl + 'api/users/user/' + id, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpHeaders */]().set('Authorization', this.bearer) });
    };
